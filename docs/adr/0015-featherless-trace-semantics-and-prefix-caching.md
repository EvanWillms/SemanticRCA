...
7. **Start with the evidence-backed minimal prompt study.** Following the experiment review, the immediate P01 study uses sanitized S01 structural fixtures: three cases, two equal-information formats and three repetitions, totaling 18 attempts. Keep the separately defined S09 status study for later. No hidden warmups, automatic repairs or substitutions. A conditional six-attempt cache smoke changes evidence after a shared prefix and compares matched target-case controls; it requires natural-prefix eligibility and observable cache evidence. Neither study establishes general semantic understanding or diagnostic accuracy.
...
## Amendment: reviewed experiments and minimal prompt test

On 2026-09-17 the user requested review of experiments to date and a minimal semantic-tokenization/caching test. [The review](../../specs/008-featherless-trace-semantics/experiment-review.md) found validated S01 structural fixtures, no model-token/caching results, and embedded pass-rule leakage in saved packets. [P01](../../specs/008-featherless-trace-semantics/minimal-test.md) therefore replaces the planned first-study priority, while S09's meaning and acceptance remain unchanged. The six-call cache smoke supersedes the earlier 12-call sketch only for this immediate test. This is a design amendment, not new experiment evidence.
