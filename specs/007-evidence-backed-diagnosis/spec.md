...
The immediate structural P01 prompt probe and its conditional cache smoke are specified in [feature 008's minimal test](../008-featherless-trace-semantics/minimal-test.md). S09 remains a distinct later status study; neither result alone establishes diagnostic integration.
